...
const PHASE_LABELS: Record<MachiningPhase, string> = {
  IDLE: 'Idle',
  MOVE_TO_PICK: 'Moving to raw table',
  PICKING: 'Picking part',
  MOVE_UP_FROM_PICK: 'Lifting part',
  MOVE_TO_CNC: 'Moving to CNC',
  OPEN_CNC_DOOR: 'Opening CNC door',
  LOAD_PART: 'Loading part into CNC',
  CLOSE_CNC_DOOR: 'Closing CNC door',
  MACHINING: 'Machining…',
  OPEN_CNC_DOOR_RETRIEVE: 'Waiting for machining',
  RETRIEVE_PART: 'Retrieving machined part',
  MOVE_UP_FROM_CNC: 'Lifting from CNC',
  MOVE_TO_FINISHED_TABLE: 'Moving to finished table',
  PLACING: 'Placing finished part',
  MOVE_UP_FROM_PLACE: 'Releasing part',
  COMPLETE: 'Complete',
}
